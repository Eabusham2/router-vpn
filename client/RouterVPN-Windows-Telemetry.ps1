...
'@
    ...
    $ProductSource+="`n# Windows telemetry UX contract: fastest-node connect dropdown, live path RTT beside Connect/Disconnect, live multihop IN/OUT/PATH RTT, authenticated real path Mbps, real routed hop Mbps when reachable, separate MTU optimizer, Performance panel, Forward shortcut, node-map median-ms refresh.`n"
