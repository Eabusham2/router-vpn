...
# The tracked v5 source is the shipping source. Keep the concrete DNS cleanup
# regressions that were caught by -Werror from returning; do not hide warnings
# or compile a rewritten temporary v5 copy.
