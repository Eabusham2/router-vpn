...
func (s RouterProfileStore) MarshalJSON() ([]byte, error) { clone := copyProfileStoreForJSON(s); if err := NormalizeRouterProfileStore(&clone); err != nil { return nil, err }; return json.Marshal(routerProfileStoreWire(clone)) }