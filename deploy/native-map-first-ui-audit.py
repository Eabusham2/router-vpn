...
require(
    ...
    "AUTO — first proven path",
    "New CUSTOM preset…",
    "private func editingPreset()",
    "private func preservedUnknownLayers()",
    "selectedLayers() + preservedUnknownLayers()",
    "candidate.name.caseInsensitiveCompare(editing!.name)",
    "real-coordinate",
    "packet",
    "Real path speed",
    "Routed hop speeds",
