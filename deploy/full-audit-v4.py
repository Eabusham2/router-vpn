...
need("android/app/src/main/java/com/eabusham/routervpn/NativeAmneziaWGController.java","org.amnezia.awg.backend.GoBackend","State.UP","Config.parse",'profiles.optJSONObject(rawProfileID)', '"awg2-fast".equals(rawProfileID)', '"awg2-strong".equals(rawProfileID)', 'another raw mode will not be substituted',"AndroidKillSwitchPolicy.strictRequested(privateBundle)","AndroidNativeProfilePolicy.patchWireGuardLikeConfig","AndroidPathProbe.prove(privateBundle, 8000)","recoverAfterNetworkChange","network-transition recovery failed closed")
...
need("client/Setup-Windows-Runtime.ps1","1.13.12","26.7.11","SHA-256 mismatch","e93fc531134eb1beb4efa3c74990a24e48456098a31c03b60d5ddf17f223cf98","Install-RouterVPNBundledXray -BundleRoot $AppRoot -Destination $Runtime -Architecture $arch")
need("client/Install-Bundled-Xray.ps1","50231eaff98ccc31b5cbd247a721c16e97fe5ec1","Get-FileHash","policy_sha256","XRAY-RUNTIME.json","schema_version","toolchain","[IO.File]::Replace")
...
need("ios/RouterVPN/project.yml","NSLocalNetworkUsageDescription","com.apple.networkextension.packet-tunnel","WireGuardKit","9d5ee60edefa95b933a738dd7cda671dd18021fc","Build pinned wireguard-go bridge","libwg-go.a")
