...
ios_libbox_rel = ".github/workflows/ios-libbox-engine.yml"
...
ios_libbox = read(ios_libbox_rel)
...
require(ios_compile_smoke, ios_compile_smoke_rel,
        ...
        '"ios-app"',
        '"ios-packet-tunnel"')
require(ios_libbox, ios_libbox_rel,
        'ROUTER_VPN_SOURCE_SHA="$GITHUB_SHA"',
        'plutil -extract RouterVPNSourceSHA raw "$APP/Info.plist"',
        'plutil -extract RouterVPNArtifactFamily raw "$APP/Info.plist"',
        'plutil -extract RouterVPNSourceSHA raw "$APP/PlugIns/RouterVPNPacketTunnel.appex/Info.plist"',
        'plutil -extract RouterVPNArtifactFamily raw "$APP/PlugIns/RouterVPNPacketTunnel.appex/Info.plist"')
...
require(broker, "server/scripts/download-broker.py",
        ...
        "def _verified_artifact_zip",
        "GitHub artifact archive SHA-256 digest mismatch",
...
require(broker_exact_sha_test, broker_exact_sha_test_rel,
        ...
        "artifact_digest_metadata_is_mandatory_and_strict",
        "verified_artifact_zip_hashes_and_uses_same_descriptor",
        "download_limited_cleans_partial_and_length_mismatched_artifacts",
        "fetch_artifact_member_verifies_outer_digest_before_extraction",
        "digest_failure_falls_through_to_next_exact_sha_desktop_producer",
