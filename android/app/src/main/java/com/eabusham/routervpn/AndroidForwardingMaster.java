...
final class AndroidForwardingMaster {
    ...
    private boolean request(Boolean requested)throws Exception{
        ...
        if(uri.getHost()==null||uri.getHost().isEmpty()||!("http".equalsIgnoreCase(uri.getScheme())||"https".equalsIgnoreCase(uri.getScheme())))throw new IllegalStateException("Private Router API URL is invalid.");
