...
func (a *app) pairProfileBundle(w http.ResponseWriter, r *http.Request) {
	...
	client := &http.Client{
		...
		CheckRedirect: func(_ *http.Request, _ []*http.Request) error {
			return fmt.Errorf("pairing redirects are not allowed")
		},
	}
	...
	// Reuse the hardened import path so node identity, endpoint normalization,
	// staging, traversal limits, busy-state locking, and atomic persistence stay
	// identical for file imports and LAN pairing.
	...
	a.importProfileBundle(capture, importReq)
