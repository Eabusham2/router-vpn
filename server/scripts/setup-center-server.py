...
class Handler(_broker.Handler):
    ...
    def _serve_setup_html(self, name: str) -> None:
        ...
        try:
            raw = _broker.read_verified_regular(path, private=True)
            text = _inject_admin_ui(raw.decode("utf-8"))
...
def main() -> int:
    ...
    _broker.validate_private_directory(base)
    static = _broker.validate_private_directory(base / "downloads")
