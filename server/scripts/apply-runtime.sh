...
add rule inet router_vpn_guard input iifname "$WAN" ip6 saddr fd00::/8 accept
...
add rule inet router_vpn_guard input iifname "$WAN" tcp dport { $REALITY_PORT, $SS_PORT } accept
